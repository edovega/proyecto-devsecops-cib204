...
|---|---|---|---|
| Código | CIB-204 | PDF programa | ✅ validado |
| Nombre | Seguridad del Software | PDF programa | ✅ validado |
| Universidad | Universidad CENFOTEC | PDF programa | ✅ validado |
| Sede | Central | PDF programa | ✅ validado |
| Programa | Maestría en Ciberseguridad | PDF programa | ✅ validado |
| Créditos | 4 | PDF programa | ✅ validado |
| Duración | Cuatrimestral | PDF programa | ✅ validado |
| Modalidad | Presencial (teoría 2 h + práctica 1 h semanal) | PDF programa | ✅ validado |
| Naturaleza | Teórico–Práctico | PDF programa | ✅ validado |
| Requisitos | CIB-201 Seguridad de los Datos | PDF programa | ✅ validado |
| Nivel | Posgrado | PDF programa | ✅ validado |
| Peso del proyecto | 40% (Primer avance 10% + Segundo avance 15% + Informe final 15%) | PDF programa | ✅ validado |
