...
RAIZ="$(cd "$(dirname "$0")/.." && pwd)"; cd "$RAIZ" || exit 1
{
  ...
  ls docs/informe-maestro.md docs/informe-maestro.docx docs/plantilla-diagnostico.md docs/reporte-docente-devcontainer.md docs/auditoria/AUDITORIA-IA-EXTERNA.md
